...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if(totalTasks > 0 &&
      completedTasks === totalTasks) {
        ...
        quoteText.innerHTML = `
        <span class="fire success-title">WOW!</span><br>
        Maybe if you<br>
        <span class="success-pink">KEEP COMPLETING</span><br>
        your tasks like this,<br>
        your future self<br>
        <span class="success-purple">WILL BE SO PROUD</span>
    `;
    ...
    quoteText.innerHTML = `
        <span class="fire">BE DISCIPLINE</span><br>
        YOUR FUTURE<br>
        SELF IS<br>
        WATCHING –<br>
        <span class="highlight">MAKE HER/HIM PROUD</span>
    `;
